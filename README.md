...
```scala
libraryDependencies += "io.github.edadma" %%% "sdl3"       % "0.2.1"
libraryDependencies += "io.github.edadma" %%% "sdl3_ttf"   % "0.2.1"
libraryDependencies += "io.github.edadma" %%% "sdl3_image" % "0.2.1"
libraryDependencies += "io.github.edadma" %%% "sdl3_mixer" % "0.2.1"
```
